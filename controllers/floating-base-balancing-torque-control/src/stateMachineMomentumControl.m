...
persistent TWO_FEET_TRAJECTORY_Counter;
...
if isempty(TWO_FEET_TRAJECTORY_Counter)
    TWO_FEET_TRAJECTORY_Counter = 1; 
end
...
%%TWO_FEET_TRAJECTORY DEMO
if Config.TWO_FEET_TRAJECTORY_DEMO
    ...
    if TWO_FEET_TRAJECTORY_Counter < size(StateMachine.joints_TWO_FEET_TRAJECTORYRef,1)
        
            jointPos_des = StateMachine.joints_TWO_FEET_TRAJECTORYRef(TWO_FEET_TRAJECTORY_Counter,:)';
        
        TWO_FEET_TRAJECTORY_Counter = TWO_FEET_TRAJECTORY_Counter +1 ;
